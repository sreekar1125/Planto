...
public class HelpInfo7 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_helpinfo7);
        ...
        myes1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(HelpInfo7.this,"Thanks for your feedback", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
